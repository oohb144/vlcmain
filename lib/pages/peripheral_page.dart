          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              GridView.count(
                ...
                mainAxisSpacing: 12,
                children: const [
                  StatCard(label: '人脸开门', value: '已启用', sub: '今日 8 次', valueSize: 18, tone: StatTone.green, icon: Icons.face),
                  StatCard(label: '指纹开门', value: '已启用', sub: '今日 4 次', valueSize: 18, tone: StatTone.green, icon: Icons.fingerprint),
                  StatCard(label: 'NFC 刷卡', value: '已启用', sub: '今日 3 次', valueSize: 18, tone: StatTone.green, icon: Icons.nfc),
                  StatCard(label: '密码开门', value: '已启用', sub: '今日 2 次', valueSize: 18, tone: StatTone.green, icon: Icons.dialpad),
                ],
              ),
